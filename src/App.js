...
const BddDemo = function () {
  ...
  return ( <
    ...
    /h3> <
    img src = {
      myTime ? sunAndCLoudUrl : moonAndStarUrl
    }
    alt = {
      myTime ? "Sun and cloud" : "moon and star"
    }
    /> <
    p className = "font-sty-italic" >
    Maria reading the news papper in the {
      myTime
    }
    with light {
      " "
    ...
    <
    img src = {
      myLight ? bulbLightOn : bulbLightOff
    }
    alt = {
      myLight ? "Bulb light on" : "Bulb light off"
    }
    /> <
    ...
    src = {
      myLight ? homeWithLightUrl : homeWithoutLightUrl
    }
    alt = "home" /
    >
    <
...
const Gherkins = () => ( <
  ...
  a href = "https://twitter.com/anilbms75"
  target = "_blank"
  ...
  a href = "https://github.com/anilkk/bdd-cucumber-demo"
  target = "_blank"
  rel = "noopener noreferrer" >
  Github <
  /a>
